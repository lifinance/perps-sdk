...
import type { OnFill, OnFillDirection } from '../types/wire.js'

const DIRECTION_CLASSIFICATIONS: Record<OnFillDirection, FillClassification> = {
 ...
 * @public
 */
export const mapFill = (fill: OnFill, market: MarketDisplay): Fill => ({
  id: fill.id,
